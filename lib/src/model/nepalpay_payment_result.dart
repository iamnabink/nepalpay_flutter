...
class NepalPayPaymentResult {
  /// Creates an [NepalPayPaymentResult] with the given object either [data] or [error] (but not both).
  NepalPayPaymentResult({this.error, this.data});
